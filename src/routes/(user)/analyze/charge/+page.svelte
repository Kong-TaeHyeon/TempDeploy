	...
	<div class="mt-[38px] mb-[38px]">
		...
		<div class="bg-slate-50 rounded-[25px] w-[1200px]">
			<div class="flex flex-row gap-[25px] p-4 ml-10">
				<div>
					<p class="text-black text-[22px] font-medium mb-[21px]">충전 누적 내역</p>
					<TotalCharge />
				</div>

				<div>
					<p class="text-black text-[22px] font-medium mb-[21px]">충전 시간별 분석</p>
					<AnalyzeCharge />
				</div>
			</div>

			<div class="flex flex-col p-4 ml-10">
				<p class="text-black text-[22px] font-medium mb-[21px]">충전 상세 내역</p>
